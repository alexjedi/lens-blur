...
const ShaderMaterial = () => {
  ...
  useFrame((state, delta) => {
    vScrollDamp.current += (vScroll.current - vScrollDamp.current) * delta * 0.4
...
const ThreeScene = () => {
  return (
    <section className="relative w-100vw h-[400vh] overflow-scroll">
      ...
      <div className="relative z-10 p-8 text-white">
        <h1>Scroll down to see the shader effect</h1>
        <p>Some content here...</p>
        <p style={{ marginTop: '200vh' }}>More content to scroll through...</p>
      </div>
    </section>
  )
}
